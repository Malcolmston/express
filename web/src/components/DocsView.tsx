...
export function DocsView({ lib }: DocsViewProps) {
  return (
    <section className="view active" id="view-docs">
      ...
      <p className="muted">The complete package-by-package Go API reference, generated from source. It documents every exported type, function and method across the {lib.name} module and its 100+ helper packages.</p>
