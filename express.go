// Package express is a fast, minimalist web framework for Go, modeled after
// the Node.js Express framework. It provides a familiar routing API, chainable
// request/response helpers, and middleware support on top of the standard
// library's net/http package.
//
